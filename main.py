...
"""
# n=list(input("sayıları girin ve virgülle ayırın :"))
# d=tuple(n)
# print(n,d)
...
if the output received is 26.0, it should be printed as 26) In case of input data being supplied to the question, it should be assumed to be a console input.
"""
